...
export const AllPlayersCall = () => async dispatch => {
  ...
  try {
    ...
    const response = await fetch(`api/v1/players`, { mode: 'cors' });
...
export const PlayerCall = (id) => async dispatch => {
  ...
  try {
    ...
    const response = await fetch(`api/v1/players/${id}`, { mode: 'cors' });
...
export const TrainingsCall = () => async dispatch => {
  ...
  try {
    ...
    const response = await fetch(`api/v1/trainings`, { mode: 'cors' });
